...
module.exports.run = async (bot, message, args) => {
    ...
    const categoryId = "663329041054433281";
    ...
    message.guild.createChannel(userName + "-" + userDiscriminator, "text").then((createdChan) => { // Maak kanaal
        ...
        createdChan.setParent(categoryId).then((settedParent) => { // Zet kanaal in category.
            ...
            settedParent.overwritePermissions(message.guild.roles.find('name', "@HR || Modérateur"), {"READ_MESSAGES": true, "SEND_MESSAGES": true, "CONNECT": true});
